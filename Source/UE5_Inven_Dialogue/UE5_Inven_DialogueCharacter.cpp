...
AUE5_Inven_DialogueCharacter::AUE5_Inven_DialogueCharacter()
{
...
void AUE5_Inven_DialogueCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUE5_Inven_DialogueCharacter::Move);
...
void AUE5_Inven_DialogueCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUE5_Inven_DialogueCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AUE5_Inven_DialogueCharacter::GetHasRifle()
{
	return bHasRifle;
}